...
class YoutubeRef extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <>
        {this.props.refValue.channel === "" ? null : (
          <p
            id="ref"
            ...
            ref={this.initRef}
          >
            {this.props.refValue.channel} {this.props.refValue.year}.{" "}
            <em> {this.props.refValue.title}.</em>
            {this.props.refValue.postedDate}.{this.props.refValue.url}{" "}
